...
var Menu = __name8((props) => {
  ...
  React18.useEffect(() => {
    const handleKeyDown = __name8(() => {
      isUsingKeyboardRef.current = true;
      document.addEventListener("pointerdown", handlePointer, { capture: true, once: true });
      document.addEventListener("pointermove", handlePointer, { capture: true, once: true });
    }, "handleKeyDown");
    const handlePointer = __name8(() => isUsingKeyboardRef.current = false, "handlePointer");
  ...
  React18.useEffect(() => {
    ...
    const handleBlur = __name8(() => handleOpenChange(false), "handleBlur");
...
var MenuAnchor = React18.forwardRef(
  __name8(function MenuAnchor2(props, forwardedRef) {
...
var MenuContent = React18.forwardRef(
  __name8(function MenuContent2(props, forwardedRef) {
...
var MenuRootContentModal = React18.forwardRef(
  // blank line to reduce diff noise
  __name8(function MenuRootContentModal2(props, forwardedRef) {
    const context = useMenuContext(CONTENT_NAME2, props.__scopeMenu);
...
var MenuRootContentNonModal = React18.forwardRef(__name8(function MenuRootContentNonModal2(props, forwardedRef) {
  const context = useMenuContext(CONTENT_NAME2, props.__scopeMenu);
  return (0, import_jsx_runtime6.jsx)(
    MenuContentImpl,
    {
...
var MenuContentImpl = React18.forwardRef(
  // blank line to reduce diff noise
  __name8(function MenuContentImpl2(props, forwardedRef) {
    const {
      __scopeMenu,
      loop = false,
      trapFocus,
    ...
    const handleTypeaheadSearch = __name8((key) => {
      var _a, _b;
      ...
      __name8(function updateSearch(value) {
...
var MenuGroup = React18.forwardRef(
  __name8(function MenuGroup2(props, forwardedRef) {
...
var MenuLabel = React18.forwardRef(
  __name8(function MenuLabel2(props, forwardedRef) {
...
var MenuItem = React18.forwardRef(
  // blank line to reduce diff noise
  __name8(function MenuItem2(props, forwardedRef) {
...
var MenuItemImpl = React18.forwardRef(
  __name8(function MenuItemImpl2(props, forwardedRef) {
...
var MenuCheckboxItem = React18.forwardRef(
  // blank line to reduce diff noise
  __name8(function MenuCheckboxItem2(props, forwardedRef) {
...
var [RadioGroupProvider, useRadioGroupContext] = createMenuContext(
  RADIO_GROUP_NAME,
  { value: void 0, onValueChange: __name8(() => {
  }, "onValueChange") }
);
var MenuRadioGroup = React18.forwardRef(
  __name8(function MenuRadioGroup2(props, forwardedRef) {
...
var MenuRadioItem = React18.forwardRef(
  __name8(function MenuRadioItem2(props, forwardedRef) {
...
var MenuItemIndicator = React18.forwardRef(
  // blank line to reduce diff noise
  __name8(function MenuItemIndicator2(props, forwardedRef) {
...
var MenuSeparator = React18.forwardRef(
  __name8(function MenuSeparator2(props, forwardedRef) {
...
var MenuArrow = React18.forwardRef(
  __name8(function MenuArrow2(props, forwardedRef) {
    const { __scopeMenu, ...arrowProps } = props;
    const popperScope = usePopperScope(__scopeMenu);
    return (0, import_jsx_runtime6.jsx)(Arrow3, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }, "MenuArrow")
);
var SUB_NAME = "MenuSub";
var [MenuSubProvider, useMenuSubContext] = createMenuContext(SUB_NAME);
var MenuSub = __name8((props) => {
...
var MenuSubTrigger = React18.forwardRef(
  __name8(function MenuSubTrigger2(props, forwardedRef) {
...
var MenuSubContent = React18.forwardRef(
  __name8(function MenuSubContent2(props, forwardedRef) {
    const portalContext = usePortalContext(CONTENT_NAME2, props.__scopeMenu);
...
__name8(getOpenState, "getOpenState");
...
__name8(getCheckedState, "getCheckedState");
...
__name8(focusFirst2, "focusFirst");
function wrapArray(array, startIndex) {
  return array.map((_, index2) => array[(startIndex + index2) % array.length]);
}
__name8(wrapArray, "wrapArray");
...
__name8(getNextMatch, "getNextMatch");
...
__name8(isPointInPolygon, "isPointInPolygon");
function isPointerInGraceArea(event, area) {
  if (!area) return false;
  const cursorPos = { x: event.clientX, y: event.clientY };
  return isPointInPolygon(cursorPos, area);
}
__name8(isPointerInGraceArea, "isPointerInGraceArea");
function whenMouse(handler) {
  return (event) => event.pointerType === "mouse" ? handler(event) : void 0;
}
__name8(whenMouse, "whenMouse");
var Root3 = Menu;
...
var DropdownMenu = __name9((props) => {
  const {
    __scopeDropdownMenu,
    children,
    dir,
...
var DropdownMenuTrigger = React19.forwardRef(
  // blank line to reduce diff noise
  __name9(function DropdownMenuTrigger2(props, forwardedRef) {
...
var DropdownMenuPortal = __name9((props) => {
...
var DropdownMenuContent = React19.forwardRef(
  // blank line to reduce diff noise
  __name9(function DropdownMenuContent2(props, forwardedRef) {
...
var DropdownMenuGroup = React19.forwardRef(
  // blank line to reduce diff noise
  __name9(function DropdownMenuGroup2(props, forwardedRef) {
...
var DropdownMenuLabel = React19.forwardRef(
  // blank line to reduce diff noise
  __name9(function DropdownMenuLabel2(props, forwardedRef) {
...
var DropdownMenuItem = React19.forwardRef(
  // blank line to reduce diff noise
  __name9(function DropdownMenuItem2(props, forwardedRef) {
    const { __scopeDropdownMenu, ...itemProps } = props;
    const menuScope = useMenuScope(__scopeDropdownMenu);
    return (0, import_jsx_runtime7.jsx)(Item2, { ...menuScope, ...itemProps, ref: forwardedRef });
  }, "DropdownMenuItem")
);
var DropdownMenuCheckboxItem = React19.forwardRef(__name9(function DropdownMenuCheckboxItem2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...checkboxItemProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime7.jsx)(CheckboxItem, { ...menuScope, ...checkboxItemProps, ref: forwardedRef });
}, "DropdownMenuCheckboxItem"));
var DropdownMenuRadioGroup = React19.forwardRef(__name9(function DropdownMenuRadioGroup2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...radioGroupProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime7.jsx)(RadioGroup, { ...menuScope, ...radioGroupProps, ref: forwardedRef });
}, "DropdownMenuRadioGroup"));
var DropdownMenuRadioItem = React19.forwardRef(__name9(function DropdownMenuRadioItem2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...radioItemProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime7.jsx)(RadioItem, { ...menuScope, ...radioItemProps, ref: forwardedRef });
}, "DropdownMenuRadioItem"));
var DropdownMenuItemIndicator = React19.forwardRef(__name9(function DropdownMenuItemIndicator2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...itemIndicatorProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime7.jsx)(ItemIndicator, { ...menuScope, ...itemIndicatorProps, ref: forwardedRef });
}, "DropdownMenuItemIndicator"));
var DropdownMenuSeparator = React19.forwardRef(__name9(function DropdownMenuSeparator2(props, forwardedRef) {
...
var DropdownMenuArrow = React19.forwardRef(
  // blank line to reduce diff noise
  __name9(function DropdownMenuArrow2(props, forwardedRef) {
    const { __scopeDropdownMenu, ...arrowProps } = props;
    const menuScope = useMenuScope(__scopeDropdownMenu);
    return (0, import_jsx_runtime7.jsx)(Arrow22, { ...menuScope, ...arrowProps, ref: forwardedRef });
  }, "DropdownMenuArrow")
);
var DropdownMenuSub = __name9((props) => {
...
var DropdownMenuSubTrigger = React19.forwardRef(__name9(function DropdownMenuSubTrigger2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...subTriggerProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime7.jsx)(SubTrigger, { ...menuScope, ...subTriggerProps, ref: forwardedRef });
}, "DropdownMenuSubTrigger"));
var DropdownMenuSubContent = React19.forwardRef(__name9(function DropdownMenuSubContent2(props, forwardedRef) {
