      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="hidden md:flex items-center gap-2 ml-1">
            <Btn variant="marigold" size="sm" onClick={() => navigate("/post-ad")}>Post an Ad</Btn>
      ...
      {open && (
        <div className="lg:hidden bg-white dark:bg-[#0B1120] border-t border-slate-100 dark:border-white/10 px-5 py-4 animate-fadeUp">
          <div className="flex flex-col gap-1">
            ...
            <Btn variant="marigold" className="mt-1" onClick={() => { navigate("/post-ad"); setOpen(false); }}>Post an Ad</Btn>
